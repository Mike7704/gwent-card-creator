...
export const abilityIcons = {
  ...
  Horn2: "/images/ability/card_ability_horn2.png",
  Mardroeme: "/images/ability/card_ability_mardroeme.png",
  Mardroeme2: "/images/ability/card_ability_mardroeme2.png",
  ...
  Scorch: "/images/ability/card_ability_scorch2.png",
  Scorch2: "/images/ability/card_ability_scorch.png",
...
export const typeStrengthIcon = {
  Standard: "/images/type/power_normal.png",
  Hero: "/images/type/power_hero.png",
};

export const factionBanner = {
  "Northern Realms": "/images/banner/banner_northern_realms.png",
  Nilfgaard: "/images/banner/banner_nilfgaard.png",
  ScoiaTael: "/images/banner/banner_scoiatael.png",
  Monsters: "/images/banner/banner_monsters.png",
  Skellige: "/images/banner/banner_skellige.png",
};
